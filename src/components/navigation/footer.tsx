...
import { footerAnimation } from "../ui/animation";
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#081029] text-white relative pt-[170px]" id="footer">
      <div className=" absolute top-[-140px] left-1/2 transform -translate-x-1/2 w-full container mx-auto flex items-center justify-between bg-[#3761eb] p-14 rounded-[20px] ">
        <div className="ftr-element">
          ...
          <p className="text-[15px] text-[#e1e1e2] mt-4">
            Find your perfect flight. without the hassle See what you can save
            today.
          </p>
        </div>
        <button className="bg-white text-[#3661eb]  py-2 px-4 rounded-[5px] ftr-element">
          Search Now
        </button>
      </div>
      <main className="ftr-element flex items-center justify-between container mx-auto bg-[#192452] p-8 rounded-[20px] ">
        <article className="space-y-2 ftr-element">
          ...
          <div className="flex items-center">
            <input
              ...
              className="p-2 w-[300px] rounded-[8px] text-[15px]"
            />
          ...
          <p className="text-[13px] text-[#a3a4a5] max-w-[550px]">
            ...
            content to resolve updates from our company
          </p>
        </article>
        <div className="flex justify-between gap-20 ftr-element">
